...
import { BookingPriceBreakdownProps } from "@/types/booking-types";
    ...
    >
      ...
      <div className="px-4 sm:px-6 py-4 sm:py-5">
        <div className="space-y-2">
          {/* Header */}
          <div
            className="grid grid-cols-5 gap-2 pb-2 border-b text-xs font-medium uppercase tracking-wide"
            style={{
          ...
          {visibleItems.map((item, idx) => (
            <div
              key={item.priceBreakDownId || idx}
              className="grid grid-cols-5 gap-2 p-2 rounded-lg text-sm"
              style={{
                backgroundColor:
                  idx % 2 === 0
