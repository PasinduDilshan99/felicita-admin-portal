// components/hero-section-components/terminate-hero-section-components/HeroSectionStats.tsx
"use client";
...
export const HeroSectionStats: React.FC<HeroSectionStatsProps> = ({
  heroDetails,
}) => {
  ...
  const statItems: StatItem[] = [
    ...
    {
      label: "Status",
      value: heroDetails.status || "Unknown",
      icon: <AlertCircle size={14} />,
      color: getStatusColor(heroDetails.status),
      formatter: (val) => val,
    },
    {
      label: "Created By",
      value: heroDetails.createdByUsername,
      icon: <User size={14} />,
      color: theme.primary,
      formatter: (val) => val,
    },
    {
      label: "Created At",
      value: formatDate(heroDetails.createdAt),
    ...
    {
      label: "Updated At",
      value: formatDate(heroDetails.updatedAt),
      icon: <Calendar size={14} />,
      color: theme.textSecondary,
      formatter: (val) => val,
    },
