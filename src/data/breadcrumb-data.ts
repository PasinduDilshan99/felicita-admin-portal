...
export const BOOKING_STATUS_ADD_BREADCRUMB_DATA: breadcrumbType[] = [
  ...BOOKING_STATUS_HOME_BREADCRUMB_DATA,
  { label: "Create", href: URLS.BOOKING_STATUS_ADD_PAGE_URL },
];

export const BOOKING_STATUS_UPDATE_BREADCRUMB_DATA: breadcrumbType[] = [
  ...BOOKING_STATUS_HOME_BREADCRUMB_DATA,
...
export const BOOKING_ASSIGN_ADD_BREADCRUMB_DATA: breadcrumbType[] = [
  ...BOOKING_ASSIGN_HOME_BREADCRUMB_DATA,
...
export const WEBSITE_CONTENT_MANAGEMENT_BREADCRUMB_DATA: breadcrumbType[] = [
  {
    label: "Website Content Management",
    href: URLS.WEBSITE_CONTENT_MANAGEMENT_URL,
  },
...
export const HOME_PAGE_MANAGEMENT_BREADCRUMB_DATA: breadcrumbType[] = [
  ...WEBSITE_CONTENT_MANAGEMENT_BREADCRUMB_DATA,
  { label: "Home Page", href: URLS.WEB_HOME_PAGE_URL },
];

export const HOME_PAGE_HERO_SECTION_MANAGEMENT_BREADCRUMB_DATA: breadcrumbType[] =
  [
    ...HOME_PAGE_MANAGEMENT_BREADCRUMB_DATA,
    { label: "Hero Section", href: URLS.HOME_HERO_SECTION_URL },
  ];

export const HOME_PAGE_HERO_SECTION_VIEW_BREADCRUMB_DATA: breadcrumbType[] = [
  ...HOME_PAGE_HERO_SECTION_MANAGEMENT_BREADCRUMB_DATA,
  { label: "View", href: URLS.HOME_HERO_SECTION_VIEW_URL },
];

export const HOME_PAGE_HERO_SECTION_DETAILS_VIEW_BREADCRUMB_DATA: breadcrumbType[] =
  [...HOME_PAGE_HERO_SECTION_VIEW_BREADCRUMB_DATA];

export const HOME_PAGE_HERO_SECTION_ADD_BREADCRUMB_DATA: breadcrumbType[] = [
  ...HOME_PAGE_HERO_SECTION_MANAGEMENT_BREADCRUMB_DATA,
  { label: "Add", href: URLS.HOME_HERO_SECTION_ADD_URL },
];

export const HOME_PAGE_HERO_SECTION_UPDATE_BREADCRUMB_DATA: breadcrumbType[] = [
  ...HOME_PAGE_HERO_SECTION_MANAGEMENT_BREADCRUMB_DATA,
  { label: "Update", href: URLS.HOME_HERO_SECTION_UPDATE_URL },
];

export const HOME_PAGE_HERO_SECTION_TERMINATE_BREADCRUMB_DATA: breadcrumbType[] =
  [
    ...HOME_PAGE_HERO_SECTION_MANAGEMENT_BREADCRUMB_DATA,
