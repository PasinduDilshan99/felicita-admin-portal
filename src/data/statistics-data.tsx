...
export const getHeroSectionStatisticsData = (
  statistics: any,
): StatCardType[] => {
  if (!statistics) return [];
  ...
  return [
    {
      title: "Total",
      value: statistics.summary.totalHeroSections,
      accent: "blue",
      icon: (
        <svg
          viewBox="0 0 24 24"
    ...
    {
      title: "Active",
      value: statistics.summary.activeHeroSections,
      accent: "emerald",
      icon: (
        <svg
          viewBox="0 0 24 24"
    ...
    {
      title: "Inactive",
      value: statistics.summary.inactiveHeroSections,
      accent: "rose",
      icon: (
        <svg
          viewBox="0 0 24 24"
    ...
    {
      title: "Terminated",
      value: statistics.summary.terminatedHeroSections,
      accent: "violet",
      icon: (
        <svg
          viewBox="0 0 24 24"
    ...
    },
    {
      ...
      value: statistics.summary.createdThisMonth,
      accent: "amber",
      icon: (
        <svg
          viewBox="0 0 24 24"
    ...
    },
    {
      ...
      value: statistics.summary.updatedThisMonth,
      accent: "teal",
      icon: (
        <svg
          viewBox="0 0 24 24"
