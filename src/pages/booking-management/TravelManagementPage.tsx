...
import { BOOKING_MANAGEMENT_HOME_BREADCRUMB_DATA } from "@/data/breadcrumb-data";
...
const TravelManagementPage = () => {
  ...
  const filteredCategories = React.useMemo(
    () =>
      bookingManagementSideBarData.filter(
        (cat) =>
      ...
      <div className="sticky top-0 z-10 backdrop-blur-sm border-b transition-all duration-300">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <PageHeader
            ...
            description="Manage your bookings content and settings"
            breadcrumbItems={BOOKING_MANAGEMENT_HOME_BREADCRUMB_DATA}
          />
        </div>
